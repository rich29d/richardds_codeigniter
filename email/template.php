                        ...
                        <td width='400' align="left">
                            <div class="contentEditableContainer contentImageEditable">
                                <div class="contentEditable">
                                    <img src="http://www.richardds.com.br/assets/img/logo-rs-email.png" alt="Logo" width='*' height='75' data-default="placeholder" data-max-width="300" data-max-height="100">
                                </div>
                            </div>
                        </td>
                        <td width='20'></td>
                                ...
                                <tr>
                                    ...
                                    <td width='305'>
                                        <div class="contentEditableContainer contentTextEditable">
                                            <div class="contentEditable">
                                                <p style="font-size: 24px"><b>[nome]</b></p>[email]
                                                <br/>
                                                <br/>
                                                <p>[msg]</p>
                                            </div>
