...
<head>
        ...
        $(function(){
            ...
            function startGame() {
                ...
                dispara = function () {
                    ...
                    if (playerSelected) {
                        var canvasX = canvasWidth/2;//Math.floor(e.pageX);
                        var canvasY = 630;//Math.floor(e.pageY);
                ...
                $(document).on('mouseup', function(e) { dispara(); });
    ...
    <script>
        ...
        var pusher = new Pusher('408ae86aa0b3e01a9235', {
            cluster: 'us2',
            encrypted: true
        });

        var channel = pusher.subscribe('private-teste-1');
...
<div id="game">
    <div id="gameUI">
        <div id="gameStats">
            ...
            <p><a class="gameReset" href="http://rawkes.com/experiments/foundation-canvas/space-bowling/">Reset</a></p>
        </div>
        <div id="gameComplete">
            <h1>You win!</h1>
            <p>Congratulations, you completed the game in <span class="gameScore"></span> clicks.</p>
            <p><a class="gameReset button" href="http://rawkes.com/experiments/foundation-canvas/space-bowling/">Play again</a></p>
        </div>
    </div>
